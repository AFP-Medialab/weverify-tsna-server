...
const TweetDialog = (props) => {
  ...
  const isConnectionEnable = useSelector(
    (state) => state.conn.connectionEnable,
  );
  ...
  if (props.open && tweetText === "") {
    if (props.creditType === "desinfo") {
      var tweetTextTemp =
        keyword("textTweet_1") + topic + keyword("textTweet_2") + "\n";
                ...
                <Grid container direction="row">
                  ...
                  >
                    ...
                    <Typography variant="body1">
                      <a
                        style={{ color: "#51A5B2" }}
                        href={props.selectedURL[0].string}
                        target="_blank"
                      >
                        {props.selectedURL[0].string}
                      </a>
                  ...
                  >
                    ...
                    {props.selectedURL[0].name && (
                      <div>
                        ...
                        >
                          <a
                            href={"https://" + props.selectedURL[0].website}
                            target="_blank"
                          >
                            <LinkIcon
                              style={{
                    ...
                    {props.selectedURL[0].debunks && (
                      <>
                        ...
                        >
                          {props.creditType === desinfo ? (
                            props.selectedURL[0].debunks.map(
                              (debunk, index) => (
                                <ListItem
                                  key={index}
                                  component="a"
