...
import { MuiThemeProvider, Paper } from "@mui/material";
          ...
          columns={state.columns.map((obj) => {
            ...
            if (obj.field === "credibility") {
              return {
                ...
                render: (rowData) =>
                  rowData.credibility === "OK" ? (
                    <FactCheckerIcon
                      onClick={() =>
                        handleClick(rowData.credibility_details, factcheck)
                      }
                      style={{ cursor: "pointer" }}
                    />
                  ) : rowData.credibility === "KO" ? (
                    <DesinformationIcon
                      onClick={() =>
                        handleClick(rowData.credibility_details, desinfo)
                      }
                      style={{ cursor: "pointer" }}
                    />
                  ) : (
