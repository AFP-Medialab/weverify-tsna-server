...
export function createBubbleChartOfMostActiveUsers(props, keyword) {
  ...
  if (props.data[0].facebook_id) {
    ...
    nbDays = Math.floor(
      (getEpochMillis(getDataResult[2]) - getEpochMillis(getDataResult[1])) /
        86400000,
    );
...
*/
  ...
  let sortedObjArr = _.orderBy(
    closestDateObjArr,
    ["post_created", "screen_name"],
    ["asc", "asc"],
  );
