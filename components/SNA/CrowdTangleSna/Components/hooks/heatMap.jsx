export function displayPostsInsta(filteredTweets, sortedColumn) {
  ...
  if (sortedColumn === "nbLikes") {
    ...
    columns = [
      ...
      {
        title: "ct_sna_total_interactions",
  ...
  filteredTweets.forEach((postObj) => {
    ...
    resData.push({
      ...
      screen_name: (
        <a
          href={"https://instagram.com/" + postObj.user_name}
          target="_blank"
      ...
      link: (
        <a href={postObj.link} target="_blank" rel="noopener noreferrer">
          {postObj.link}{" "}
        </a>
      ),
    });
...
export function displayPostsFb(filteredTweets, sortedColumn) {
  ...
  if (sortedColumn === "nbLikes") {
    columns = [
      ...
      { title: "ct_sna_result_username", field: "screen_name" },
      {
        title: "ct_sna_result_post",
        field: "post" /*, render: getPostWithClickableLink*/,
      },
      { title: "ct_sna_likes", field: "nbLikes", defaultSort: "desc" },
  ...
  filteredTweets.forEach((postObj) => {
    ...
    resData.push({
      ...
      screen_name: (
        <a
          href={"https://facebook.com/" + postObj.user_name}
          target="_blank"
          rel="noopener noreferrer"
        >
          {postObj.user_name}
