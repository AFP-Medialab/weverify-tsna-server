  ...
  const onClickNodeSocioSemantic4ModeGraph = (data) => {
    ...
    if (data.data.node.type === "Hashtag") {
      ...
      let filteredTweets = state.result.data
        ...
        .map((tweet) => {
          return tweet.description.toLowerCase().includes(selectedHashtag);
        });
      ...
      let filteredTweets2 = state.result.data
        .filter(
          (tweet) =>
            tweet.image_text !== undefined && tweet.image_text !== null,
        )
        .map((tweet) => {
          return tweet.image_text.toLowerCase().includes(selectedHashtag);
        });
      ...
      if (type === "FB") {
        let filteredTweets3 = state.result.data
          ...
          .map((tweet) => {
            return tweet.message.toLowerCase().includes(selectedHashtag);
          });
      ...
      let filteredTweets = state.result.data
        ...
        .map((tweet) => {
          return tweet.description.toLowerCase().includes(selectedUser);
        });
      ...
      let filteredTweets2 = state.result.data
        ...
        .map((tweet) => {
          return tweet.image_text.toLowerCase().includes(selectedUser);
        });
      ...
      if (type === "FB") {
        let filteredTweets3 = state.result.data
          ...
          .map((tweet) => {
            return tweet.message.toLowerCase().includes(selectedUser);
          });
      ...
      let filteredTweets = state.result.data
        ...
        .map((tweet) => {
          return tweet.description.includes(selectedURL);
        });
      ...
      let filteredTweets2 = state.result.data
        ...
        .map((tweet) => {
          return tweet.image_text.includes(selectedURL);
        });
      ...
      if (type === "FB") {
        let filteredTweets3 = state.result.data
          ...
          .map((tweet) => {
            return tweet.message.includes(selectedURL);
          });
            ...
            functionNodes={
              <Grid item>
                <CSVLink
                  ...
                  filename={
                    "Nodes_" +
                    keyword("ct_sosem_4mode_graph_title") +
                    "_" /*+ request.keywordList.join('&') + '_' + request.from + "_" + request.until */ +
                    ".csv"
                  }
