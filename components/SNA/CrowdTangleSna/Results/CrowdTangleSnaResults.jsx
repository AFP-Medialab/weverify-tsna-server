...
const BubbleChart = dynamic(import("../Components/BubbleChartCSV"), {
  ssr: false,
});
const HashtagGraph = dynamic(import("../Components/HashtagGraph"), {
  ssr: false,
});
const SocioSemGraph = dynamic(import("../Components/SocioSemGraph"), {
  ssr: false,
});
      ...
      >
        <Grid item xs={widthIndex} style={{ position: "sticky", top: "100px" }}>
          <Card>
            <CardHeader
              ...
              title={
                ...
                >
                  {!collapsed && (
                    <Grid item xs>
                      <span>{keyword("twitter_sna_index")}</span>
                    </Grid>
                  )}
                  ...
                  {!collapsed && (
                    <Grid item>
                      <IconButton
                        onClick={props.functionNodes}
                        onClick={onClickCollapseIndex}
                      >
                        <ArrowBackIosIcon
            ...
            <Box p={3}>
              <Grid container direction="column" alignItems={alignIndex}>
                <a
                  href="#tweets"
                  smooth="true"
                ...
                >
                  <Typography variant={"h6"}>
                    {"1."}
                    {!collapsed && " " + keyword2("ct_counter_title")}
                  </Typography>
                  <Box m={1} />
                </a>
                ...
                >
                  <Typography variant={"h6"}>
                    {"2."}
                    {!collapsed && " " + keyword("user_time_chart_title")}
                  </Typography>
                  <Box m={1} />
                </a>
                ...
                >
                  <Typography variant={"h6"}>
                    {"3."}
                    {!collapsed && " " + keyword("retweets_cloud_chart_title")}
                  </Typography>
                  <Box m={1} />
                </a>
                ...
                >
                  <Typography variant={"h6"}>
                    {"4."}
                    {!collapsed && " " + keyword("likes_cloud_chart_title")}
                  </Typography>
                  <Box m={1} />
                </a>
                ...
                >
                  <Typography variant={"h6"}>
                    {"5."}
                    {!collapsed && " " + keyword("top_users_pie_chart_title")}
                  </Typography>
                  <Box m={1} />
                </a>
                ...
                >
                  <Typography variant={"h6"}>
                    {"6."}
                    {!collapsed && " " + keyword("mention_cloud_chart_title")}
                  </Typography>
                  <Box m={1} />
                </a>
                ...
                >
                  <Typography variant={"h6"}>
                    {"7."}
                    {!collapsed && " " + keyword("heatmap_chart_title")}
                  </Typography>
                  <Box m={1} />
                </a>
                ...
                >
                  <Typography variant={"h6"}>
                    {"8."}
                    {!collapsed && " " + keyword("hashtag_graph_title")}
                  </Typography>
                  <Box m={1} />
                </a>
                ...
                >
                  <Typography variant={"h6"}>
                    {"9."}
                    {!collapsed && " " + keyword("sosem_graph_title2")}
                  </Typography>
                  <Box m={1} />
                </a>
                ...
                >
                  <Typography variant={"h6"}>
                    {"10."}
                    {!collapsed && " " + keyword("top_words_cloud_chart_title")}
                  </Typography>
                  <Box m={1} />
                </a>
        ...
        <Grid item xs={widthCards}>
          {
            <div style={{ position: "relative" }}>
              ...
              ></span>
              {props.result.countSna && <Count result={props.result} />}
            </div>
          }
          {
            <div style={{ position: "relative" }}>
              ...
              ></span>
              <Box m={3} />
              {props.result.histogram && <PlotTimeLine result={props.result} />}
            </div>
          }
          ...
          }
          {
            <div style={{ position: "relative" }}>
              ...
              ></span>
              <Box m={3} />
              {props.result.heatMap && <HeatMap result={props.result} />}
            </div>
          }
          {
            <div style={{ position: "relative" }}>
          ...
          }
          {
            <div style={{ position: "relative" }}>
              ...
              ></span>
              <Box m={3} />
              {props.result.cloudChart && <CloudChart result={props.result} />}
            </div>
          }
          ...
          <Box m={3} />
          {
            <div style={{ position: "relative" }}>
              ...
              {props.result.urls && (
                <UrlList
                  result={props.result}
                  title_message={"ct_sna_result_url_in_posts"}
                  tooltip_message={"twittersna_result_submit_twitter_sna"}
                  downloadable={false}
                  topic={"this topic"}
                />
              )}
