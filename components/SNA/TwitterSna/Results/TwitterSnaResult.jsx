              ...
              <Grid container direction="column" alignItems={alignIndex}>
                ...
                >
                  <Typography variant={"h6"}>
                    {"1."}
                    {!collapsed && " " + keyword("tweetCounter_title")}
                  </Typography>
                  <Box m={1} />
                </a>
                ...
                >
                  <Typography variant={"h6"}>
                    {"7. "}
                    {!collapsed && " " + keyword("bubble_chart_title_index")}
                  </Typography>
                  <Box m={1} />
                </a>
                ...
                >
                  <Typography variant={"h6"}>
                    {"12."}
                    {!collapsed && " " + keyword("export_graph_title")}
                  </Typography>
                  <Box m={1} />
                </a>
          ...
          {result.urls && (
            <div style={{ position: "relative" }}>
              ...
              <UrlList
                result={result}
                request={request}
                title_message={"twittersna_result_url_in_tweets"}
