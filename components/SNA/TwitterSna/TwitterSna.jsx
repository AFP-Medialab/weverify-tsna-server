...
const TwitterSna = () => {
  ...
  const sna = {
    type: TW_SNA_TYPE,
    tsv: "/components/NavItems/tools/TwitterSna.tsv",
    tsvInfo: "/components/Shared/OnClickInfo.tsv",
  };
    ...
    <div className={classes.all}>
      <ThemeProvider theme={theme}>
        ...
        >
          <Grid item xs>
            <HeaderTool
              name={keyword("navbar_twitter_sna")}
              description={keyword("navbar_twitter_sna_description")}
              icon={<TwitterSNAIcon style={{ fill: "#51A5B2" }} />}
            />
          </Grid>
          <Grid item>
            <AdvancedTools />
        ...
        <StylesProvider injectFirst>
          <Card className={cardClasses.root}>
            <CustomCardHeader
              title={keyword("twittersna_searchparameters")}
              showHelp={true}
              helpText={"twittersna_explication"}
            />
