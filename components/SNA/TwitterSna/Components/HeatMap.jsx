...
export default function HeatMap(props) {
  ...
  return (
    <Card>
      <CustomCardHeader
        title={"8. " + keyword("heatmap_chart_title")}
        showHelp={true}
        helpText={"twittersna_heatmap_tip"}
      />
          ...
          {(props.result.heatMap.isAllnul && (
            ...
            <div>
              <Plot
                ...
                onClick={(e) =>
                  onHeatMapClick(e, props.result, setheatMapTweets, keyword)
                }
              />
              <Box m={1} />
            </div>
      ...
      {props.result.heatMap === undefined && ( //<Typography variant='body2'>The heatmap is still loading please wait (ADD TSV)</Typography>
