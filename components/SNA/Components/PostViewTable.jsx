...
export default function PostViewTable({
  snatype,
  setTypeValue,
  data,
  downloadEnable,
  ...
  var goToAction = [
    {
      ...
      onClick: (event, rowData) => {
        if (snatype.type == TW_SNA_TYPE) window.open(rowData.link, "_blank");
        else window.open(rowData.link.props.href, "_blank");
      },
    },
  ];
  ...
  return (
    ...
    >
      ...
      <Box m={2} />
      <CustomTable
        title={keywordSNA("sna_result_selected_posts ")}
